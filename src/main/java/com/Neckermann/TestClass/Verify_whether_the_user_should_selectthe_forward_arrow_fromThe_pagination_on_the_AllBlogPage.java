...
public class Verify_whether_the_user_should_selectthe_forward_arrow_fromThe_pagination_on_the_AllBlogPage extends TestBaseClass{

	@Test
	public void Verify_whether_the_user_should_selectthe_forward_arrow_fromThe_pagination_on_the_AllBlogPage1() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
	       ...
	       js.executeScript("window.scroll(0,7000)");
	       Thread.sleep(2000);
   	       abp.clickonpaginationforwardarrow();   
	   	   Thread.sleep(2000);
	       js.executeScript("window.scroll(0,7000)");
	       Thread.sleep(2000);
	        boolean actual = abp.visibilityofforward();
