...
public class Verify_whether_the_user_should_selectthe_individual_Blog_on_the_AllBlogPage extends TestBaseClass{
	@Test
	public void Verify_whether_the_user_should_selectthe_individual_Blog_on_the_AllBlogPage1() throws InterruptedException, IOException {
		...
		Thread.sleep(3000);
           ...
           String expectedText1 =prop.getProperty("firstblogtitle"); 	
		   String actualText1 =  driver.getTitle();
		   Assert.assertEquals(actualText1, expectedText1);
           log.info("user is directedb to the individual blog page");
