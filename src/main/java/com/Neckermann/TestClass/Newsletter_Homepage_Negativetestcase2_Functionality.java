...
public class Newsletter_Homepage_Negativetestcase2_Functionality extends TestBaseClass{
	
	
	@Test
	public void Newsletter_Homepage_Negativetestcase2_Functionality1() throws InterruptedException
	{
...
//           Thread.sleep(1000);
           ...
           if(hm.visiblityofvalid_email_error_message()==true)
